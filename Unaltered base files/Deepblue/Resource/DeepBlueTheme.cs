...
using HarmonyLib;
using Lib;
using DeepBlueTheme.Properties;

namespace DeepBlueTheme
{
    public class DeepBlueTheme : AuroraPatch.Patch
    {
        public override string Description => "Deep Blue Theme";
        ...
        private static readonly Color mainTextColor = Color.FromArgb(232, 228, 168);
        private static readonly Color disabledTextColor = ControlPaint.Dark(mainTextColor, 0.2f);
        private static readonly Color buttonBackgroundColor = Color.FromArgb(70, 67, 90);
        private static readonly Color planetColor = Color.FromArgb(0, 90, 0);
        private static readonly Color planetTextColor = Color.FromArgb(238, 216, 164);
        private static readonly Color orbitColor = Color.FromArgb(150, 150, 150);
        private static readonly Color enabledSpaceMasterButtonColor = Color.FromArgb(29, 28, 36);
        private static readonly Color enabledAutoTurnsButtonColor = Color.FromArgb(29, 28, 36);

        // Toolbar button background colors
        private static readonly Color economicsButtonBackgroundColor = Color.FromArgb(55, 65, 70);
        private static readonly Color designButtonBackgroundColor = Color.FromArgb(43, 41, 55);
        private static readonly Color fleetButtonBackgroundColor = Color.FromArgb(55, 65, 70);
        private static readonly Color groundForcesButtonBackgroundColor = Color.FromArgb(43, 41, 55);
        private static readonly Color intelligenceButtonBackgroundColor = Color.FromArgb(55, 65, 70);
        private static readonly Color explorationButtonBackgroundColor = Color.FromArgb(43, 41, 55);
        private static readonly Color personnelButtonBackgroundColor = Color.FromArgb(55, 65, 70);
        private static readonly Color surveyButtonBackgroundColor = Color.FromArgb(43, 41, 55);
        private static readonly Color technologyButtonBackgroundColor = Color.FromArgb(55, 65, 70);
        private static readonly Color sectorButtonBackgroundColor = Color.FromArgb(43, 41, 55);

        // Old colors
        private static readonly Color oldTextColor = Color.FromArgb(232, 228, 168);
